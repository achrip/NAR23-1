public class Midfielder extends Player{
    ...
    private int lowPass, loftPass;

    public Midfielder(String name, String nationality, String position, int shirtNumber, int age, int appearance, double overallRating, int lowPass, int loftPass) {
